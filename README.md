# DataBase-and-SQL_
![pictures MySQL for SQL](https://github.com/Sirotina-Elina/SQL_Seminar_6/blob/main/MySQL.jpg)
...
Для начала создадим и наполним таблицы, используя [**ЭТОТ СКРИПТ**](https://github.com/Sirotina-Elina/SQL_Seminar_4/blob/main/lesson4.sql).
